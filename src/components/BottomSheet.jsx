...
export default function BottomSheet({ phase, progress, onStart, onCancel, onAccept }) {
  ...
  return (
    <section className="sheet">
      ...
      <div className="loc"><i /><div><small>Dari</small><strong>Hati Mic</strong></div></div>
      <div className="line" />
      <div className="loc"><i className="red" /><div><small>Tujuan</small><strong>Hati Rama</strong></div></div>
